...
########################################### Scenario 1 ###########################################
  Scenario: Data display correctly for TNDSTN
    ...
    And TNDSTN display correct value <Phí> when selecting "Hãng xe" with value <Hãng Xe> and "Phiên bản" with value <Phiên Bản> and "Mục đích sử dụng" with value <Mục Đích Sử Dụng> and "Loại xe" with value <Loại Xe> and "Nhóm xe" with value <Nhóm Xe>
